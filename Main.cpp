...
PBXEXPORT LPCTSTR PBXCALL PBX_GetDescription()
{
	...
	static const TCHAR classDesc[] = {
		...
		STR("   function string group(long al_matchindex, string as_groupname)\n")
		...
		STR("   function long groupposition(long al_matchindex, string as_groupname)\n")
		STR("   function long grouplength(long al_matchindex, long al_groupindex)\n")
		STR("   function long grouplength(long al_matchindex, string as_groupname)\n")
		...
		STR("   subroutine setnameduplicates(boolean allowdup)\n")
		STR("   function boolean getnameduplicates()\n")
#ifdef _DEBUG
